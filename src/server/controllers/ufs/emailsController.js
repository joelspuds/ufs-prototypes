...
export function emailsPost(req, res) {
  ...
  htmlEmailContent =
    ...
    '                    <td width="100%" bgcolor="#2E2D62" valign="middle" align="left"><span style="padding-left: 5px;"><a href="https://www.ukri.org/" style="font-family: Helvetica, Arial, sans-serif; font-size: 28px; line-height: 1.315789474; font-weight: 100; color: #efefef; text-decoration: none;">Funding Service</a></span></a></td>\n' +
    '                </tr>\n' +
    '            </table>\n' +
    '        </td>\n' +
    '    </tr>\n' +
