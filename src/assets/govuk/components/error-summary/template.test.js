...
describe('Error-summary', () => {
  ...
  it('renders title text', () => {
    const $ = render('error-summary', examples.default);
    const summaryTitle = $('.govuk-error-summary__title')
      .text()
      .trim();
  ...
  it('renders description text', () => {
    const $ = render('error-summary', examples.default);
    const summaryDescription = $('.govuk-error-summary__body p')
      .text()
      .trim();
  ...
  it('renders error item text', () => {
    const $ = render('error-summary', examples.default);
    const errorItemText = $('.govuk-error-summary .govuk-error-summary__list li:first-child')
      .text()
      .trim();
  ...
  it('allows error item HTML to be passed un-escaped', () => {
    ...
    const errorItemText = $('.govuk-error-summary .govuk-error-summary__list li')
      .html()
      .trim();
  ...
  it('allows error item HTML inside "a" tag to be passed un-escaped', () => {
    ...
    const errorItemText = $('.govuk-error-summary .govuk-error-summary__list li a')
      .html()
      .trim();
