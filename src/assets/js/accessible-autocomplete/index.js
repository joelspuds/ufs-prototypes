export const accessibleAutocompleteModule = () => {
  !(function(e, t) {
        ...
        !(function() {
          ...
          function n(e, n) {
            ...
            for (n && null != n.children && (D.length || D.push(n.children), delete n.children); D.length; )
              if ((r = D.pop()) && void 0 !== r.pop) for (i = r.length; i--; ) D.push(r[i]);
              else
                (!0 !== r && !1 !== r) || (r = null),
                  (l = 'function' != typeof e) &&
                    (null == r ? (r = '') : 'number' == typeof r ? (r = String(r)) : 'string' != typeof r && (l = !1)),
                  l && o ? (u[u.length - 1] += r) : u === L ? (u = [r]) : u.push(r),
                  (o = l);
            var s = new t();
            return (
              (s.nodeName = e),
            ...
            if (('className' === t && (t = 'class'), 'key' === t));
              ...
              if ('style' === t) {
                ...
                (t = t.toLowerCase().substring(2)),
                  o ? n || e.addEventListener(t, h, i) : e.removeEventListener(t, h, i),
                  ((e.__l || (e.__l = {}))[t] = o);
              } else if ('list' !== t && 'type' !== t && !r && t in e)
                f(e, t, null == o ? '' : o), (null != o && !1 !== o) || e.removeAttribute(t);
              else {
          ...
          function v(e, t, n, o, r) {
            ...
            if ((null == t && (t = ''), 'string' == typeof t))
              return (
                e && void 0 !== e.splitText && e.parentNode && (!e._component || r)
                  ...
                  : ((l = document.createTextNode(t)), e && (e.parentNode && e.parentNode.replaceChild(l, e), g(e, !0))),
                (l.__preactattr_ = !0),
                l
              );
            if ('function' == typeof t.nodeName) return S(e, t, n, o);
            if (
              ((P = 'svg' === t.nodeName || ('foreignObject' !== t.nodeName && P)),
              (!e || !s(e, String(t.nodeName))) && ((l = p(String(t.nodeName), P)), e))
            ) {
            ...
            var u = l.firstChild,
              ...
              c = t.children;
            return (
              !U && c && 1 === c.length && 'string' == typeof c[0] && null != u && void 0 !== u.splitText && null == u.nextSibling
                ? u.nodeValue != c[0] && (u.nodeValue = c[0])
                : ((c && c.length) || null != u) && y(l, c, n, o, U || null != a.dangerouslySetInnerHTML),
              w(l, t.attributes, a),
              (P = i),
              l
            );
          ...
          function y(e, t, n, o, r) {
            ...
            if (0 !== _)
              for (var w = 0; w < _; w++) {
                var O = p[w],
                  C = O.__preactattr_,
                  x = b && C ? (O._component ? O._component.__k : C.key) : null;
            ...
            if (0 !== b)
              for (var w = 0; w < b; w++) {
                (s = t[w]), (a = null);
                var x = s.key;
                if (null != x) h && void 0 !== f[x] && ((a = f[x]), (f[x] = void 0), h--);
                else if (!a && m < y)
                  for (l = m; l < y; l++)
                ...
                (a = v(a, s, n, o)) &&
                  a !== e &&
                  (w >= _ ? e.appendChild(a) : a !== p[w] && (a === p[w + 1] ? c(p[w]) : e.insertBefore(a, p[w] || null)));
              }
          ...
          function C(e, t, n) {
            ...
            if (
              (e.prototype && e.prototype.render
                ? ((o = new e(t, n)), k.call(o, t, n))
                : ((o = new k(t, n)), (o.constructor = e), (o.render = x)),
              r)
            )
          ...
          function E(e, t, n, o, r) {
            e.__x ||
              ...
              o && o !== e.context && (e.__c || (e.__c = e.context), (e.context = o)),
              e.__p || (e.__p = e.props),
              (e.props = t),
              (e.__x = !1),
              0 !== n && (1 !== n && !1 === A.syncComponentUpdates && e.base ? l(e) : N(e, 1, r)),
              e.__r && e.__r(e));
          }
          function N(e, t, n, r) {
            if (!e.__x) {
              ...
              if (
                (v &&
                  ...
                  (e.state = f),
                  (e.context = h),
                  2 !== t && e.shouldComponentUpdate && !1 === e.shouldComponentUpdate(s, p, c)
                    ? (O = !0)
                    : e.componentWillUpdate && e.componentWillUpdate(s, p, c),
                  (e.props = s),
                  (e.state = p),
                  (e.context = c)),
                ...
                if ('function' == typeof k) {
                  var M = a(l);
                  (i = w),
                    i && i.constructor === k && M.key == i.__k
                      ? E(i, M, 1, c, !1)
                      : ((x = i), (e._component = i = C(k, M, c)), (i.__b = i.__b || y), (i.__u = e), E(i, M, 0, c, !1), N(i, 1, n, !0)),
                    (S = i.base);
                } else
                  (u = b),
                    (x = w),
                    x && (u = e._component = null),
                    (b || 1 === t) && (u && (u._component = null), (S = _(u, l, c, n || !v, b && b.parentNode, !0)));
                if (b && S !== b && i !== w) {
                  var D = b.parentNode;
              ...
              if (
                (!v || n
                  ? R.unshift(e)
                  : O || (m(), e.componentDidUpdate && e.componentDidUpdate(d, f, h), A.afterUpdate && A.afterUpdate(e)),
                null != e.__h)
              )
          ...
          function S(e, t, n, o) {
            for (
              var r = e && e._component, l = r, i = e, u = r && e._componentConstructor === t.nodeName, s = u, p = a(t);
              r && !s && (r = r.__u);
            ...
            return (
              r && s && (!o || r._component)
                ? (E(r, p, 3, n, o), (e = r.base))
                : (l && !u && (I(l), (e = i = null)),
                  (r = C(t.nodeName, p, n)),
                  e && !r.__b && ((r.__b = e), (i = null)),
                  E(r, p, 1, n, o),
                  (e = r.base),
                  i && e !== i && ((i._component = null), g(i, !1))),
              e
            );
          }
          function I(e) {
            ...
            var n = e._component;
            n ? I(n) : t && (t.__preactattr_ && t.__preactattr_.ref && t.__preactattr_.ref(null), (e.__b = t), c(t), O(e), b(t)),
              e.__r && e.__r(null);
          }
          function k(e, t) {
          ...
          O = ((c = p = (function(e) {
            ...
            return (
              ...
              (t.prototype.handleInputBlur = function(e) {
                ...
                if (-1 === n) {
                  var s = o && u(),
                    a = u() ? l : this.templateInputValue(r[i]);
              ...
              (t.prototype.render = function() {
                ...
                return (
                  ...
                  (0, f.createElement)(
                    'div',
                    { className: T, onKeyDown: this.handleKeyDown, role: 'combobox', 'aria-expanded': x ? 'true' : 'false' },
                    ...
                    J &&
                      (0, f.createElement)(
                        'span',
                        null,
                        (0, f.createElement)('input', { className: Q, readonly: !0, tabIndex: '-1', value: G })
                      ),
                    (0, f.createElement)(
                      'input',
                      d(
