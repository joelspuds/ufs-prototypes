            ...
            t ||
              Object.defineProperty(Function.prototype, 'bind', {
                value: function(t) {
                  ...
                  return (
                    (h = Function('binder', 'return function (' + w.join(',') + '){ return binder.apply(this, arguments); }')(function() {
                    ...
                    y.prototype && ((c.prototype = y.prototype), (h.prototype = new c()), (c.prototype = null)),
                    h
                  );
                },
              });
                ...
                (t &&
                  ...
                  (e.DOMTokenList = (function() {
                    var r = !0,
                      n = function(e, t, n, o) {
                        Object.defineProperty
                          ? Object.defineProperty(e, t, { configurable: !1 === r || !!o, get: n })
                    ...
                    return function(r, i) {
                        ...
                        p = function() {
                          ...
                          for (
                            '' ===
                              (a =
                                'object' == typeof r[i]
                                  ? ('' + r[i].baseVal).replace(/^\s+|\s+$/g, '').split(o)
                                  : ('' + r[i]).replace(/^\s+|\s+$/g, '').split(o))[0] && (a = []),
                              s = {},
                              t = 0;
                            t < a.length;
                            ++t
                      ...
                      return (
                        ...
                        (c.add = function() {
                          ...
                          l !== a.length &&
                            ((l = a.length >>> 0), 'object' == typeof r[i] ? (r[i].baseVal = a.join(' ')) : (r[i] = a.join(' ')), u());
                        }),
                        (c.remove = function() {
                          p.apply(c, (e = arguments));
                        ...
                        (c.toggle = function(e, t) {
                          return (
                            p.apply(c, [e]), o !== t ? (t ? (c.add(e), !0) : (c.remove(e), !1)) : s[e] ? (c.remove(e), !1) : (c.add(e), !0)
                          );
                        }),
                        c
                      );
                  ...
                  (function() {
                    ...
                    if (
                      'classList' in e &&
                      (e.classList.add('a'), e.classList.add('b'), e.classList.remove('a', 'b'), e.classList.contains('b'))
                    ) {
              ...
              (function() {
                if (!window.Element || window.HTMLElement) {
                  ...
                  var e,
                    ...
                    l = function(e, t) {
                      var n,
                        ...
                        i = e.childNodes || [],
                        c = -1;
                      if (1 === e.nodeType && e.constructor !== Element) for (n in ((e.constructor = Element), s)) (o = s[n]), (e[n] = o);
                      for (; (r = t && i[++c]); ) l(r, t);
                      return e;
                    },
                  ...
                  a.attachEvent('onpropertychange', function(e) {
                    ...
                    c() || ((document.onreadystatechange = c), (e = setInterval(c, 25))),
                ...
                function c() {
                  return (
                    ...
                    !(
                      ...
                      (l(document, !0), e && document.body.prototype && clearTimeout(e), !document.body.prototype)
                    )
                  );
                }
              })();
            ...
            t ||
              (function(e) {
                var u = !0,
                  p = function(e, t, n, o) {
                    Object.defineProperty
                      ? Object.defineProperty(e, t, { configurable: !1 === u || !!o, get: n })
                      : e.__defineGetter__(t, n);
                  };
                try {
                  p({}, 'support');
              ...
              ('undefined' == typeof WorkerGlobalScope &&
                ...
                (function(e) {
                  e.constructor
                    ...
                    : ((e.Window = e.constructor = new Function('return function Window() {}')()).prototype = this);
                })(this));
          }.call(('object' == typeof window && window) || ('object' == typeof self && self) || ('object' == typeof n && n) || {}),
          function(e) {
            var t = 'Document' in this;
                    ...
                    'createEvent' in document ||
                          ...
                          c._events[e] ||
                            ((c._events[e] = function(e) {
                              ...
                              for (
                                ...
                                r in o && ((t = o[r]), -1 !== a(n, t) && 'function' == typeof t && t.call(c, e));
                            }),
                            (c._events[e].list = []),
                      ...
                      (window.dispatchEvent = Window.prototype.dispatchEvent = Document.prototype.dispatchEvent = Element.prototype.dispatchEvent = function(
                        ...
                        try {
                          ...
                          for (
                            e.target = t;
                            '_events' in (e.currentTarget = t) && 'function' == typeof t._events[n] && t._events[n].call(t, e),
          ...
          (e.prototype.polyfillDetails = function() {
            ...
            t &&
              ...
              !(t.tabIndex = 0) == (null !== e.getAttribute('open'))
                ? (t.setAttribute('aria-expanded', 'true'), n.setAttribute('aria-hidden', 'false'))
                : (t.setAttribute('aria-expanded', 'false'), n.setAttribute('aria-hidden', 'true'), (n.style.display = 'none')),
          ...
          (e.prototype.polyfillHandleInputs = function(e, n) {
            e.addEventListener('keypress', function(e) {
              ...
              (13 !== e.keyCode && 32 !== e.keyCode) ||
                ('summary' === t.nodeName.toLowerCase() && (e.preventDefault(), t.click ? t.click() : n(e)));
            }),
        ...
        return (
              ...
              (function() {
                if (!window.Element || window.HTMLElement) {
                  ...
                  a.attachEvent('onpropertychange', function(e) {
                    ...
                    i() || ((document.onreadystatechange = i), (e = setInterval(i, 25))),
                    (document.createElement = function(e) {
          ...
          function(e) {
            ...
            ('document' in this &&
              ...
              'Element' in this &&
              'classList' in Element.prototype &&
              ((t = document.createElement('span')).classList.add('a', 'b'), t.classList.contains('b'))) ||
              (function(e) {
                var u = !0,
                  p = function(e, t, n, o) {
                    Object.defineProperty
          ...
          (e.prototype.init = function() {
            ...
            if (t && n) {
              ...
              this.options.maxwords && (o = this.defaults.wordCountAttribute),
                ...
                this.maxLength &&
                  (e.removeAttribute('maxlength'), this.bindChangeEvents.bind(this)(), this.updateCountMessage.bind(this)());
            }
          }),
          ...
          (e.prototype.checkIfValueChanged = function() {
            this.$textarea.oldValue || (this.$textarea.oldValue = ''),
              this.$textarea.value !== this.$textarea.oldValue &&
                ((this.$textarea.oldValue = this.$textarea.value), this.updateCountMessage.bind(this)());
          }),
          (e.prototype.updateCountMessage = function() {
            ...
            o < (r * (t.threshold ? t.threshold : 0)) / 100
              ...
              i < 0
                ? (e.classList.add('govuk-textarea--error'), n.classList.remove('govuk-hint'), n.classList.add('govuk-error-message'))
                : (e.classList.remove('govuk-textarea--error'), n.classList.remove('govuk-error-message'), n.classList.add('govuk-hint'));
            var c,
              a,
              s = 'character';
            t.maxwords && (s = 'word'),
          ...
          (e.prototype.init = function() {
            ...
            !(function o(e, t) {
              ...
              function(e) {
                ...
                t &&
                  n.querySelector('#' + t) &&
                  (e.setAttribute('aria-controls', t), e.removeAttribute('data-aria-controls'), this.setAttributes(e));
              }.bind(this)
            ),
      ...
      e.exports = (function() {
        ...
        return (
          ...
          (e.prototype.init = function() {
            var n = this.$module;
            t(
              n.querySelectorAll('input[type="radio"]'),
              function(e) {
                var t = e.getAttribute('data-aria-controls');
                t &&
                  n.querySelector('#' + t) &&
