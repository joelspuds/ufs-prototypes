...
!(function(t, e) {
      ...
      (N.qsa = function(t, e) {
        ...
        return t.getElementById && s && r
          ...
          : 1 !== t.nodeType && 9 !== t.nodeType && 11 !== t.nodeType
            ? []
            : u.call(
                s && !r && t.getElementsByClassName ? (i ? t.getElementsByClassName(o) : t.getElementsByTagName(e)) : t.querySelectorAll(e)
              );
      }),
  ...
  return (
                    ...
                    (l = function(t) {
                      var r,
                        s = e(t.target)
                          ...
                          .get(0);
                      return s && s !== o
                        ? ((r = e.extend(S(t), { currentTarget: s, liveFired: o })), (c || u).apply(s, [r].concat(i.call(arguments, 1))))
                        : void 0;
                    }),
                  y(o, t, u, a, n, l || c);
              }));
    ...
    (function(e) {
      ...
      function w(t) {
        return (
          t && (t = t.split(';', 2)[0]), (t && (t == c ? 'html' : t == f ? 'json' : a.test(t) ? 'script' : u.test(t) && 'xml')) || 'text'
        );
      }
      function T(t, e) {
