!(function(e) {
    ...
    !(function() {
      ...
      (HxOverrides.__name__ = !0),
        ...
        (HxOverrides.substr = function(e, t, n) {
          return null != t && 0 != t && null != n && n < 0
            ? ''
            : (null == n && (n = e.length), t < 0 ? (t = e.length + t) < 0 && (t = 0) : n < 0 && (n = e.length + n - t), e.substr(t, n));
        }),
      ...
      com.wiris || (com.wiris = {}),
        ...
        (com.wiris.js.JsPluginTools.getInstance = function() {
          return (
            null == com.wiris.js.JsPluginTools.instance && (com.wiris.js.JsPluginTools.instance = new com.wiris.js.JsPluginTools()),
        ...
        (haxe.Md5.prototype = {
          ...
          str2blks: function(e) {
            ...
            var a = 8 * e.length,
              s = 16 * t - 2;
            return (
              (n[s] = 255 & a), (n[s] |= ((a >>> 8) & 255) << 8), (n[s] |= ((a >>> 16) & 255) << 16), (n[s] |= ((a >>> 24) & 255) << 24), n
            );
          },
          rhex: function(e) {
            for (var t = '', n = 0; n < 4; ) {
  ...
  function(e, t, n) {
        ...
        (function(e, t, n) {
          ...
          },
          {
            ...
            value: function(e) {
              ...
              e = (e = (e = (e = e.split(t).join(o.safeXmlCharacters.tagOpener)).split(n).join(o.safeXmlCharacters.tagCloser))
                .split(i)
              ...
              '_wrs_blackboard' in window &&
                ...
                (e = (e = (e = e.split(a).join(o.safeGoodBlackboardCharacters.ltElement))
                  .split(s)
              ...
              e = (e = (e = (e = (e = e.split(t).join(o.xmlCharacters.tagOpener)).split(n).join(o.xmlCharacters.tagCloser))
                .split(i)
          ...
          },
          {
            ...
            value: function(e) {
              ...
              return (e = (e = (e = (e = (e = e.split(t).join(o.safeXmlCharacters.tagOpener)).split(n).join(o.safeXmlCharacters.tagCloser))
                .split(i)
                .join(o.safeXmlCharacters.doubleQuote))
                .split(r)
                ...
                if (e.codePointAt(n) > 128) (t += '&#'.concat(e.codePointAt(n), ';')), e.codePointAt(n) > 65535 && (n += 1);
                  ...
                  if (o >= 0) {
                    ...
                    (r.innerHTML = e.substring(n, o + 1)),
                      (t += '&#'.concat(y.fixedCharCodeAt(r.textContent || r.innerText, 0), ';')),
                      (n = o);
                  } else t += i;
                } else t += i;
              }
            ...
            value: function(e, t) {
              ...
              if (0 === i) {
                ...
                if (-1 === e.indexOf('class'))
                  return (n = ''.concat(e.substr(i, o), ' class="wrs_').concat(t, '">')), (n += e.substr(o + 1, e.length));
              }
              return e;
            },
          },
          ...
          },
          {
            ...
            value: function(e) {
              for (
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : o.xmlCharacters,
          ...
          },
          {
            ...
            value: function(t) {
              return Object.prototype.hasOwnProperty.call(e.properties, t)
                ? e.properties[t]
                : !!Object.prototype.hasOwnProperty.call(e.properties, '_wrs_conf_') && e.properties['_wrs_conf_'.concat(t)];
            },
          },
          {
            key: 'set',
              ...
              return i
                ? (void 0 === t || void 0 === t
                    ...
                    : '/' === e.substr(0, 1) || 'http://' === e.substr(0, 7) || 'https://' === e.substr(0, 8)
                      ...
                      : i.open('POST', n + e, !1),
                  void 0 !== t && t
                    ? (i.setRequestHeader('Content-type', 'application/x-www-form-urlencoded; charset=UTF-8'), i.send(y.httpBuildQuery(t)))
                    : i.send(null),
                  i.responseText)
                : '';
            },
        ...
        (function(e, t, n) {
        ...
        })(e, null, [
          {
            ...
            value: function(t) {
              var n = a.removeSemantics(t),
                ...
                r = JSON.parse(g.getService('service', o)),
                s = '';
              if ('ok' === r.status) {
                s = r.result.text;
          ...
          },
          {
            ...
            value: function(t, n) {
              ...
              n && (o.saveLatex = '');
              var r,
                s = JSON.parse(g.getService('service', o));
              if ('ok' === s.status) {
                var l = s.result.text;
                (r =
                  -1 ===
          ...
          },
          {
            ...
            value: function(t, n) {
              for (
                ...
                if (
                  ((l += t.substring(g, m)),
                  -1 === (g = t.indexOf(u, m)) ? (g = t.length - 1) : (g += u.length),
                  -1 !== (r = (i = t.substring(m, g)).indexOf(d)))
                ) {
        ...
        (function(e, t, n) {
        ...
        })(e, null, [
          {
            ...
            value: function(e) {
              var t = this.language;
              return (
                t in this.strings || (console.warn('Unknown language '.concat(t, ' set in StringManager.')), (t = 'en')),
                e in this.strings[t] ? this.strings[t][e] : (console.warn('Unknown key '.concat(e, ' in StringManager.')), e)
              );
            },
          },
        ]),
                ...
                (function t(i) {
                  if (i.getAttribute && 'WirisParam' === i.getAttribute('wirisObject')) {
                    for (var o = {}, r = 0; r < i.attributes.length; r += 1)
                      null !== i.attributes[r].nodeValue && (o[i.attributes[r].nodeName] = i.attributes[r].nodeValue);
                    ...
                    for (var u = 0; u < i.childNodes.length; u += 1)
                      t(i.childNodes[u]), 'param' === i.childNodes[u].nodeName.toLowerCase() && (c.appendChild(i.childNodes[u]), (u -= 1));
                    i.parentNode.replaceChild(c, i);
                  } else for (var d = 0; d < i.childNodes.length; d += 1) t(i.childNodes[d]);
                })(i),
                i.firstChild
              );
            },
            ...
            value: function(t, n, i) {
              ...
              if (o && (o.className === l.get('imageClassName') || o.getAttribute(l.get('imageMathmlAttribute')))) {
                ...
                var r = o.getAttribute(l.get('imageMathmlAttribute')),
                  s = a.safeXmlDecode(r);
                return (
                  l.get('saveHandTraces') || (s = a.removeAnnotation(s, 'application/json')),
                ...
                if (r.parentElement) {
                  ...
                  return (
                    'IMG' !== l.nodeName.toUpperCase() &&
                      ...
                      (l = o.document.getElementById('wrs_openEditorWindow_temporalObject'))),
                    l.nextSibling && 3 === l.nextSibling.nodeType
                      ...
                      : l.previousSibling && 3 === l.previousSibling.nodeType
                        ...
                        : ((a = o.document.createTextNode('')), l.parentNode.insertBefore(a, l), (s = 0)),
          ...
          },
          {
            ...
            value: function(t, n) {
              ...
              var o,
                ...
                s = [];
              for (
                o = n || ((r = '=' === t.charAt(t.length - 2) ? 2 : '=' === t.charAt(t.length - 1) ? 1 : 0) > 0 ? t.length - 4 : t.length),
                  a = 0;
                a < o;
                a += 4
              )
              ...
              return (
                r &&
                  (2 === r
                    ? ((i = (e.decode64(t.charAt(a)) << 2) | (e.decode64(t.charAt(a + 1)) >> 4)), s.push(255 & i))
                    : 1 === r &&
                      ((i = (e.decode64(t.charAt(a)) << 10) | (e.decode64(t.charAt(a + 1)) << 4) | (e.decode64(t.charAt(a + 2)) >> 2)),
                      s.push((i >> 8) & 255),
                      s.push(255 & i))),
                s
              );
            ...
            value: function(t, n, i) {
              ...
              if (i)
                if ('svg' === l.get('imageFormat'))
                  if ('base64' !== l.get('saveMode')) o = e.getMetricsFromSvgString(n);
                  else {
                  ...
                  (r = t.src.substr(t.src.indexOf('base64,') + 7, t.src.length)),
                    (a = y.b64ToByteArray(r, 88)),
                    (o = e.getMetricsFromBytes(a));
              else o = y.urlToAssArray(n);
              var u = o.cw;
              if (u) {
                var d = o.ch,
                  h = o.cb,
                  m = o.dpi;
                m && ((u = (96 * u) / m), (d = (96 * d) / m), (h = (96 * h) / m)),
                  (t.width = u),
                  (t.height = d),
            ...
            value: function(e) {
              ...
              for (y.readBytes(e, 0, 8); e.length >= 4; )
                1229472850 === (i = y.readInt32(e))
                  ? ((t = y.readInt32(e)), (n = y.readInt32(e)), y.readInt32(e), y.readByte(e))
                  : 1650545477 === i
                    ? (o = y.readInt32(e))
                    : 1883789683 === i && ((r = y.readInt32(e)), (r = Math.round(r / 39.37)), y.readInt32(e), y.readByte(e)),
                  y.readInt32(e);
              if (void 0 !== t) {
                var a = [];
        ...
        })(e, null, [
          {
            ...
            value: function(t, n, i, o) {
              ...
              if (!l.get('wirisPluginPerformance') || ('xml' !== l.get('saveMode') && 'safeXml' !== l.get('saveMode'))) {
                ...
                r.setAttribute(l.get('imageMathmlAttribute'), a.safeXmlEncode(n)),
                  (r.src = u),
                  A.setImgSize(r, u, 'base64' === l.get('saveMode') && 'default' === l.get('base64savemode')),
                  l.get('enableAccessibility') && (r.alt = M.mathMLToAccessible(n, o, s));
              } else {
                ...
                'png' === (d = d.result).format
                  ...
                  : (r.src = 'data:image/svg+xml;charset=utf8,'.concat(y.urlEncode(d.content))),
                  r.setAttribute(l.get('imageMathmlAttribute'), a.safeXmlEncode(n)),
                  A.setImgSize(r, d.content, !0),
                  l.get('enableAccessibility') && (void 0 === d.alt ? (r.alt = M.mathMLToAccessible(n, o, s)) : (r.alt = d.alt));
              }
            ...
            value: function(t, n) {
              return (
                l.get('saveMode') &&
                  ...
                  'base64' === l.get('saveMode') && 'image' === l.get('base64savemode') && (t = e.codeImgTransform(t, 'base642showimage'))),
                t
              );
            },
          },
              ...
              return (
                l.get('saveMode') &&
                  ('safeXml' === l.get('saveMode')
                    ...
                    : 'xml' === l.get('saveMode')
                      ? (t = e.codeImgTransform(t, 'img2mathml'))
                      : 'base64' === l.get('saveMode') && 'image' === l.get('base64savemode') && (t = e.codeImgTransform(t, 'img264'))),
                t
              );
            },
          },
          {
            ...
            value: function(e, t) {
              ...
              return (
                ...
                (o.formula = com.wiris.js.JsPluginTools.md5encode(y.propertiesToString(n))),
                (o.lang = void 0 === t ? 'en' : t),
                (o.version = l.get('version')),
                g.getService('showimage', y.httpBuildQuery(o), !0)
              );
            },
          },
          {
            ...
            value: function(t, n) {
              for (var i = '', o = 0, r = /<img/gi, s = r.source.length; r.test(t); ) {
                ...
                var m = t.substring(c, o),
                  g = y.createObject(m),
                  f = g.getAttribute(l.get('imageMathmlAttribute')),
                  p = void 0,
                  _ = void 0;
                if ('base642showimage' === n)
                  null == f && (f = g.getAttribute('alt')),
                    (f = a.safeXmlDecode(f)),
                    (m = e.mathmlToImgObject(document, f, null, null)),
                    (i += y.createObjectCode(m));
                else if ('img2mathml' === n)
                  l.get('saveMode') &&
                    ('safeXml' === l.get('saveMode') ? ((p = !0), (_ = !0)) : 'xml' === l.get('saveMode') && ((p = !0), (_ = !1))),
                    (i += y.getWIRISImageOutput(m, p, _));
                else if ('img264' === n) {
          ...
          },
          {
            ...
            value: function(t, n, i) {
              for (
                ...
                if (
                  (-1 === (d = t.indexOf(c, u)) ? (d = t.length - 1) : (d += -1 !== h ? t.indexOf('/>', u) : c.length),
                  a.isMathmlInAttribute(t, u) || -1 !== h)
                )
                  r += t.substring(u, d);
                else {
                  var m = t.substring(u, d);
                  (m = n.id === o.safeXmlCharacters.id ? a.safeXmlDecode(m) : a.mathMLEntities(m)),
                    (r += y.createObjectCode(e.mathmlToImgObject(document, m, null, i)));
                }
                u = t.indexOf(s, d);
              }
        ...
        (function(e, t, n) {
            ...
            value: function() {
              if (
                ...
                if (
                  ...
                  y.addEvent(t, 'focus', this.modalDialogInstance.handleOpenedIosSoftkeyboard),
                    y.addEvent(t, 'blur', this.modalDialogInstance.handleClosedIosSoftkeyboard);
                }
          ...
          },
          {
            ...
            value: function() {
              ...
              (n.href = t),
                0 === window.location.href.indexOf('https://') && 'http:' === n.protocol && (n.protocol = 'https:'),
                (t =
                  '80' === n.port || '443' === n.port
                    ...
                    : ''
                        ...
                        .concat(n.pathname));
              var i = {};
              'editor' in this.environment ? (i.editor = this.environment.editor) : (i.editor = 'unknown'),
                'mode' in this.environment ? (i.mode = this.environment.mode) : (i.mode = l.get('saveMode')),
                'version' in this.environment ? (i.version = this.environment.version) : (i.version = l.get('version')),
                (e.src = ''
                  .concat(t, '?lang=')
            ...
            value: function() {
              this.deviceProperties.isAndroid || this.deviceProperties.isIOS
                ? this.editor.getEditorModel().isRTL()
                  ...
                  : this.setMathML('<math><semantics><annotation encoding="application/json">[]</annotation></semantics></math>', !0)
                : this.editor.getEditorModel().isRTL()
            ...
            value: function(e) {
              if (void 0 !== e.key && !1 === e.repeat)
                if ('Escape' === e.key || 'Esc' === e.key) {
                  ...
                  0 === t.length &&
                    0 === (t = document.getElementsByClassName('wrs_expandButton wrs_expandButtonFor2RowsLayout wrs_pressed')).length &&
                  ...
                  if (document.activeElement === this.modalDialogInstance.cancelButton)
                    ...
                    'wrs_formulaDisplay wrs_focused' === document.getElementsByClassName('wrs_formulaDisplay')[0].getAttribute('class') &&
          ...
          },
          {
            ...
            value: function() {
              'block' !== this.overlayWrapper.style.display
                ? (document.activeElement.blur(), (this.overlayWrapper.style.display = 'block'), this.closeButton.focus())
                : ((this.overlayWrapper.style.display = 'none'), _wrs_modalWindow.focus());
            },
          },
          {
            key: 'cancelAction',
        ...
        X(e, [
              ...
              this.titleBar.appendChild(this.closeDiv),
                ...
                this.deviceProperties.isDesktop
                  ...
                  : this.deviceProperties.isAndroid
                    ...
                    : this.deviceProperties.isIOS && !this.deviceProperties.isMobile && this.createModalWindowIos(),
          ...
          },
          {
            ...
            value: function() {
              (this.resizerBR = document.createElement('div')),
                ...
                y.addEvent(this.resizerBR, 'mousedown', this.activateResizeStateBR.bind(this)),
                y.addEvent(this.resizerTL, 'mousedown', this.activateResizeStateTL.bind(this));
            },
          },
          {
              ...
              if (
                ...
                this.properties.created
                  ? (this.properties.open ||
                      ((this.properties.open = !0), this.deviceProperties.isAndroid || this.deviceProperties.isIOS || this.restoreState()),
                    this.deviceProperties.isDesktop && l.get('modalWindowFullScreen') && this.maximize(),
                    this.deviceProperties.isIOS &&
                      ((this.iosSoftkeyboardOpened = !1), this.setContainerHeight(''.concat(100 + this.iosMeasureUnit))))
                  : this.create(),
          ...
          },
          {
            ...
            value: function() {
              ...
              e
                ? i(e, t)
                : ((e = document.createElement('meta')), document.getElementsByTagName('head')[0].appendChild(e), i(e, t), e.remove());
            },
          },
          {
            ...
            value: function() {
              'maximized' === this.properties.state
                ...
                : 'minimized' === this.properties.state
                  ? ((this.properties.state = this.properties.previousState), (this.properties.previousState = ''), this.minimize())
                  : this.stack();
            },
          },
          {
            ...
            value: function() {
              this.saveModalProperties(),
                'minimized' === this.properties.state && 'stack' === this.properties.previousState
                  ? this.stack()
                  : 'minimized' === this.properties.state && 'maximized' === this.properties.previousState
                    ? this.maximize()
                    : ((this.container.style.height = '30px'),
                      ...
                      y.containsClass(this.overlay, 'wrs_stack') ? this.removeClass('wrs_stack') : this.removeClass('wrs_maximized'),
              ...
              this.saveModalProperties(),
                ...
                y.containsClass(this.overlay, 'wrs_minimized')
                  ...
                  : y.containsClass(this.overlay, 'wrs_stack') &&
                    ((this.container.style.left = null), (this.container.style.top = null), this.removeClass('wrs_stack')),
          ...
          },
          {
            ...
            value: function() {
              this.maximizeDiv.addEventListener('click', this.maximize.bind(this), !0),
                ...
                y.addEvent(window, 'keydown', this.onKeyDown.bind(this));
            },
          },
          {
            key: 'removeListeners',
            value: function() {
              y.removeEvent(window, 'mousedown', this.startDrag),
                ...
                y.removeEvent(window, 'keydown', this.onKeyDown);
            },
          },
          {
            key: 'eventClient',
          ...
          },
          {
            ...
            value: function(e) {
              if (this.dragDataObject) {
                ...
                (this.lastDrag = { x: i, y: o }), (this.container.style.transform = 'translate3d('.concat(i, ',').concat(o, ',0)'));
              }
                ...
                l < 0 && (l = 0),
                  ...
                  this.leftScale ||
                    (this.resizeDataObject.x - l - this.initialWidth < -580
                      ? (this.container.style.right = ''.concat(this.initialRight - (l - this.resizeDataObject.x), 'px'))
                    ...
                    this.resizeDataObject.y - c < this.initialHeight - 338
                      ? (this.container.style.bottom = ''.concat(this.initialBottom - (c - this.resizeDataObject.y), 'px'))
          ...
          },
          {
            ...
            value: function() {
              ...
              return { minPointer: { x: e - c - this.scrollbarWidth, y: u }, maxPointer: { x: this.container.offsetWidth - c, y: d } };
            },
          },
          {
          ...
          },
          {
            ...
            value: function() {
              (this.container.style.right = ''.concat(
                Math.min(parseInt(this.container.style.right, 10), window.innerWidth - this.scrollbarWidth - this.container.offsetWidth),
                'px'
              )),
      ...
      (function() {
        var e = function(e) {
          ...
          if ((i != i && (i = 0), !(i < 0 || i >= n))) {
            var o,
              r = t.charCodeAt(i);
            return r >= 55296 && r <= 56319 && n > i + 1 && (o = t.charCodeAt(i + 1)) >= 56320 && o <= 57343
              ...
              value: function(e, t, n, i) {
                ...
                if (n)
                  if ('latex' === this.editMode) {
                    ...
                    } else o.node = t.document.createTextNode('$$'.concat(o.latex, '$$'));
                    this.insertElementOnSelection(o.node, e, t);
                  } else (o.node = E.mathmlToImgObject(t.document, n, i, this.language)), this.insertElementOnSelection(o.node, e, t);
            ...
            },
            {
              ...
              value: function(t, n, i, o) {
                ...
                return (
                  ...
                  (r.node = i),
                  (r.latex = o),
                  this.listeners.fire('onAfterFormulaInsertion', r) ? {} : (e.globalListeners.fire('onAfterFormulaInsertion', r), {})
                );
              },
            },
            {
              ...
              value: function(e, t, n) {
                if (this.editionProperties.isNewElement)
                  if (e)
                    if ('textarea' === t.type) y.updateTextArea(t, e.textContent);
                      ...
                      this.editionProperties.range
                        ? ((a = this.editionProperties.range), (this.editionProperties.range = null))
                        : (a = r.getRangeAt(0)),
                        a.deleteContents();
                  ...
                  (d =
                    ...
                    y.updateExistingTextOnTextarea(t, e.textContent, d.startPosition, d.endPosition);
                } else
                  e && 'img' === e.nodeName.toLowerCase()
                    ? (A.removeImgDataAttributes(this.editionProperties.temporalImage), A.clone(e, this.editionProperties.temporalImage))
            ...
            },
            {
              ...
              value: function(e, t) {
                    ...
                    if (!n.caretPosition && y.containsClass(n.node, l.get('imageClassName')))
                      ...
                      if (this.integrationModel.getMathmlFromTextNode) {
                        ...
                        s &&
                          ...
                          this.editionProperties.temporalImage.setAttribute(l.get('imageMathmlAttribute'), a.safeXmlEncode(s)));
                      } else {
                        ...
                        if (c) {
                          ...
                          (this.editMode = 'latex'),
                            (this.editionProperties.isNewElement = !1),
                            (this.editionProperties.temporalImage = document.createElement('img')),
                            this.editionProperties.temporalImage.setAttribute(l.get('imageMathmlAttribute'), a.safeXmlEncode(u));
                          ...
                          if ('textarea' !== e.tagName.toLowerCase())
                            if (document.selection) {
                              ...
                              (this.editionProperties.latexRange = d.document.selection.createRange()),
                                ...
                                this.editionProperties.latexRange.move('character', m + c.startPosition),
                ...
                if (
                  ...
                  ((this.contentManager.isNewElement = this.editionProperties.isNewElement), null != this.editionProperties.temporalImage)
                ) {
        ...
        (function(e, t, n) {
        ...
        })(e, [
          {
            ...
            value: function() {
              ...
              (a = 0 === a.indexOf('/') || 0 === a.indexOf('http') ? a : y.concatenateUrl(this.getPath(), a)),
          ...
          },
          {
            ...
            value: function(e) {
              if ('img' === e.nodeName.toLowerCase()) {
                ...
                y.containsClass(e, l.get('imageClassName')) &&
    ...
    (Y.prototype.getMathmlFromTextNode = void 0),
      ...
      (Y.integrationParameters = ['serviceProviderProperties', 'editorParameters']);
    var ee = (function(e) {
      function t(e) {
        var n;
        return (
          ...
          ((n = Z(this, G(t).call(this, e))).initParsed = e.initParsed),
          (n.isMoodle = e.isMoodle),
          (n.isExternal = e.isExternal),
          n
        );
      }
      return (
        (function(e, t) {
          ...
          (e.prototype = Object.create(t && t.prototype, { constructor: { value: e, writable: !0, configurable: !0 } })), t && $(e, t);
        })(t, Y),
        (function(e, t, n) {
          ...
          },
          {
            key: 'getIconsPath',
            value: function() {
              return this.isMoodle && l.get('versionPlatform') < 2013111800
                ? this.getPath() + 'icons/tinymce3/'
                : this.getPath() + 'icons/';
            },
          },
          {
          ...
          },
          {
            ...
            value: function() {
              ...
              this.isIframe
                ? void 0 !== E.observer &&
                  Array.prototype.forEach.call(this.target.contentDocument.getElementsByClassName(i), function(e) {
              ...
              this.getCore().addListener(o),
                (n[this.editorObject.id] = this.editorObject.settings.images_dataimg_filter),
                (this.editorObject.settings.images_dataimg_filter = function(t) {
                  return t.hasAttribute('class') && -1 != t.getAttribute('class').indexOf(l.get('imageClassName'))
                    ? t.hasAttribute('internal-blob')
                    : void 0 === n[e.editorObject.id] || n[e.editorObject.id](t);
                });
            },
          },
          {
            key: 'updateFormula',
            value: function(e) {
              void 0 !== this.editorObject.fire && this.editorObject.fire('ExecCommand', { command: 'updateFormula', value: e }),
    ...
    tinymce.create('tinymce.plugins.tiny_mce_wiris', {
      init: function(e, t) {
        ...
        (n.serviceProviderProperties.URI = 'https://www.wiris.net/demo/plugins/app'),
          (n.serviceProviderProperties.server = 'java'),
          (n.version = '7.16.0.1424'),
          (n.isMoodle = !1),
          void 0 !== e.getParam('wiriscontextpath') &&
            ((n.configurationService = y.concatenateUrl(e.getParam('wiriscontextpath'), n.configurationService)),
            e.getParam('wiriscontextpath'),
            n.configurationService,
            console.warn('Deprecated property wiriscontextpath. Use mathTypeParameters on instead.', e.opts.wiriscontextpath)),
          void 0 !== e.getParam('mathTypeParameters') && (n.integrationParameters = e.getParam('mathTypeParameters')),
          (n.scriptName = 'plugin.min.js'),
          (n.environment = {});
        var i = '4';
        '5' === tinyMCE.majorVersion && (i = '5'),
          (n.environment.editor = 'TinyMCE ' + i + '.x'),
          (n.callbackMethodArguments = {}),
          (n.editorObject = e),
          (n.initParsed = !1),
          (n.target = null);
        ...
        var a = function(e) {
          ...
          e.inline ? t.setTarget(e.getElement()) : t.setTarget(e.getContentAreaContainer().firstChild),
            t.setEditorObject(e),
            t.listeners.fire('onTargetReady', {}),
            'wiriseditorparameters' in e.settings && l.update('editorParameters', e.settings.wiriseditorparameters),
                  ...
                  function(e, t) {
                    Array.prototype.forEach.call(
                      ...
                      function(e, t) {
                        1 == t.nodeType &&
                          Array.prototype.forEach.call(
                            t.querySelectorAll('.'.concat(WirisPlugin.Configuration.get('imageClassName'))),
                            function(e, t) {
            ...
            ).observe(e.getBody(), { attributes: !0, childList: !0, characterData: !0, subtree: !0 });
          var n = e.getContent();
          e.setContent(E.initParse(n, e.getParam('language')), { format: 'html' }),
            e.undoManager.clear(),
            (WirisPlugin.instances[e.id].initParsed = !0);
        };
        'onInit' in e
          ? e.onInit.add(a)
          : e.on('init', function() {
        ...
        if (
          ('onSaveContent' in e
            ? e.onSaveContent.add(c)
            : e.on('saveContent', function(t) {
                c(e, t);
              }),
          'onGetContent' in e
            ? e.onGetContent.add(c)
            : e.on('getContent', function(t) {
                c(e, t);
              }),
          'onBeforeSetContent' in e
            ? e.onBeforeSetContent.add(function(t, n) {
          ...
          (s = e.ui.registry).addIcon(
            ...
            s.addMenuItem('tiny_mce_wiris_formulaEditor', { text: 'MathType', icon: 'mathtypeicon', onAction: u });
          var d = WirisPlugin.instances[e.id].getCore().getCustomEditors();
          Object.keys(d.editors).forEach(function(t) {
            d.editors[t].confVariable &&
              s.addMenuItem('tiny_mce_wiris_formulaEditor'.concat(d.editors[t].name), {
        ...
        } else (s = e).addCommand('tiny_mce_wiris_openFormulaEditor', u);
        ...
        for (var m in h.editors)
          if (h.editors[m].confVariable) {
            ...
            e.addCommand(f, g),
              s.addButton('tiny_mce_wiris_formulaEditor' + h.editors[m].name, {
