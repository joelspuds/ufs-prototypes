...
function dataTestGet(req, res) {
  ...
  let credentials = {
    installed: {
      client_id: '3748321640-b9o5fkildantldsmkmgss1tdiuah8vm3.apps.googleusercontent.com',
      project_id: 'quickstart-1576678685799',
...
function dataTestPost(req, res) {
  ...
  return res.redirect('/prototypes/gds/data-from-docs');
}