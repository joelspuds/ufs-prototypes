...
let convertDate = function (crapDate, isAmerican = true, separatorChar = '/') {
  ...
  if (isAmerican) {
    ...
    console.log('Is American, newDayNumber = ' + newDayNumber + ' newDayName = ' + newDayName, '  newMonth = ' + newMonth, '  newYear = ' + newYear);
  } else {
    newDayName = days[dataAsArray[0] + 1];
    newDayNumber = dataAsArray[0];
    newMonth = months[dataAsArray[1] - 1];
    newYear = dataAsArray[2];
    console.log('Is NOT American, newDayNumber = ' + newDayNumber + ' newDayName = ' + newDayName, '  newMonth = ' + newMonth, '  newYear = ' + newYear);
  }
