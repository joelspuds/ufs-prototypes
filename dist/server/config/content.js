...
let contentItems = {
  // site-wide items
  GLOBAL_TAG_TITLE_SUFFIX: ' - The Funding Service',
  // generic pages
  ...
  ADD_FUNDERS_TO_OPPORTUNITY_NAME_HINT: 'These details will be shared internally and made public when the Opportunity launches.',
  ...
  // Application journey
  APPLICATION_OVERVIEW_TITLE_TAG: 'Application',
  APPLICATION_OVERVIEW_TITLE: 'Application',
  APPLICATION_PROJECT_DETAILS_TITLE_TAG: 'Details',
  APPLICATION_PROJECT_DETAILS_TITLE: 'Details',
  APPLICATION_TEAM_TITLE_TAG: 'Applications team',
  APPLICATION_TEAM_TITLE: 'Applications team',
  APPLICATION_CAPABILITY_TO_DELIVER_TITLE_TAG: 'Capability to deliver',
  APPLICATION_CAPABILITY_TO_DELIVER_TITLE: 'Capability to deliver',
  APPLICATION_RESOURCES_COST_TITLE_TAG: 'Resources and cost',
